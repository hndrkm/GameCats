...
namespace CatGame
{
    public class Matchmaking : BaseService, INetworkRunnerCallbacks
    {
        ...
        public async Task LeaveLobby()
        {
            ...
            // tiiip: Agregar el cierre 'PhotonCloudTimeout' evitara el return anticipado y los servicios en la nube
            // sera limpiado (descascarado) correctamente sin servicios limpios volver a unirse al lobby siempre fallara
            // se puede eliminar después de la corrección del SDK de Fusion
        ...
        protected override void OnInitialize()
        {
            ...
            _lobbyName = "MysticCat." + Application.version;
